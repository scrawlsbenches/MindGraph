...
export const CROSS_CLUSTER_BRIDGES = [
  ...
  [1, 4, 'arrive', 'festival'],
  [2, 3, 'strange', 'room'],
  [2, 3, 'discover', 'hallway'],
  [2, 3, 'light', 'window'],
  [2, 3, 'quiet', 'house'],
  [2, 4, 'explore', 'workshop'],
  [2, 4, 'curious', 'art'],
  [2, 4, 'nice', 'show'],
  [2, 4, 'bright', 'festival'],
  [3, 4, 'house', 'festival'],
...
export const PHYSICS = {
  ...
  REPULSION_CLUSTER: 0.1, // same-cluster label repulsion strength
  ...
  DAMPING: 0.9, // velocity damping per frame (0=freeze, 1=no friction)
